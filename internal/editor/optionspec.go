...
var optionSpecs = []optionSpec{
	...
	{"insertCursor", false, optIntKind, nil},
	{"overwriteCursor", false, optIntKind, nil},
	{"navigationCursor", false, optIntKind, nil},
	...
	{"rtlMarkMode", false, optEnumKind, []string{"auto", "normal", "iterm2", "compose", "drift"}},
}
