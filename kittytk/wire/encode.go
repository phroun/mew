...
// out of text from somewhere else has to ask. Three things stop a string: a
// character a bare token cannot hold, a leading sign -- which says the token is
// a number and nothing else -- and spelling a number, which is what it would
// come back as.
